...
export interface IDemoFormRight {
...
export const DemoFormRight: React.FunctionComponent<IDemoFormRight> = ({
  hero,
  testimonialArray,
  hubspot,
  collage,
            ...
            bottomElem={
              <div className="container relative flex flex-col pb-32 mx-auto -mt-48 border-b-4 pt-80 z-5 border-darken-300">
                <div className="flex flex-row justify-between sm:flex-col-reverse">
                  ...
                  {testimonialArray && (
                    <ContentBlock className="ml-12 sm:w-100 sm:items-center sm:text-center sm:pr-0">
...
export default withRouteData(DemoFormRight);
